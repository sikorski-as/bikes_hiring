...
(
  STATION_ID NUMBER(4) NOT NULL generated always as identity
...
CREATE TABLE USERS 
(
  USER_ID NUMBER(7) NOT NULL generated always as identity
, SURNAME VARCHAR2(20) 
...
CREATE TABLE BIKES 
(
  BIKE_ID NUMBER(6) NOT NULL generated always as identity
...
CREATE TABLE HIRES 
(
  HIRE_ID NUMBER(8) NOT NULL generated always as identity
...
(
  TERMINAL_ID NUMBER(6) NOT NULL generated always as identity
