...
(
  STATION_ID NUMBER(4) GENERATED ALWAYS as IDENTITY NOT NULL 
...
CREATE TABLE USERS 
(
  USER_ID NUMBER(7) GENERATED ALWAYS as IDENTITY NOT NULL 
, SURNAME VARCHAR2(20) 
...
CREATE TABLE BIKES 
(
  BIKE_ID NUMBER(6) GENERATED ALWAYS as IDENTITY NOT NULL 
...
CREATE TABLE HIRES 
(
  HIRE_ID NUMBER(8) GENERATED ALWAYS as IDENTITY NOT NULL 
...
(
  TERMINAL_ID NUMBER(6) GENERATED ALWAYS as IDENTITY NOT NULL 
